...
from emg_utils_ki import extract_features_wamp, filter_active_muscles
...
"""
wandle binäre Vorhersagen in Onset/Offset-Paare um
"""
...
def onsetDetection_lgbm(file_path, model_path=MODEL_PATH, min_dauer_ms=2000, schwelle=0.3):
    ...
    plot_onset(emg_data, all_phases, t_signal, "LGBM + WAMP")
...
if __name__ == "__main__":
    ...
    onsetDetection_lgbm(FILE_PATH, min_dauer_ms=2000)
